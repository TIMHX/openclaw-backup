...
complete -c openclaw -n "__fish_seen_subcommand_from memory-pro" -a "auth" -d 'Manage OAuth authentication for smart-extraction LLM access'
...
complete -c openclaw -n "__fish_seen_subcommand_from auth" -a "login" -d 'Authenticate with ChatGPT/Codex in a browser, save the plugin OAuth file, and switch this plugin to llm.auth=oauth'
complete -c openclaw -n "__fish_seen_subcommand_from auth" -a "status" -d 'Show the current OAuth configuration for this plugin'
complete -c openclaw -n "__fish_seen_subcommand_from auth" -a "logout" -d 'Delete the plugin OAuth file and switch this plugin back to llm.auth=api-key'
complete -c openclaw -n "__fish_seen_subcommand_from login" -l config -d 'OpenClaw config file to update'
complete -c openclaw -n "__fish_seen_subcommand_from login" -l provider -d 'OAuth provider to use (openai-codex (OpenAI Codex))'
complete -c openclaw -n "__fish_seen_subcommand_from login" -l model -d 'Override the model saved into llm.model'
complete -c openclaw -n "__fish_seen_subcommand_from login" -l oauth-path -d 'OAuth file path (default: ~/.openclaw/.memory-lancedb-pro/oauth.json)'
complete -c openclaw -n "__fish_seen_subcommand_from login" -l timeout -d 'OAuth callback timeout in seconds'
complete -c openclaw -n "__fish_seen_subcommand_from login" -l no-browser -d 'Do not auto-open the browser; print the authorization URL only'
complete -c openclaw -n "__fish_seen_subcommand_from status" -l config -d 'OpenClaw config file to inspect'
complete -c openclaw -n "__fish_seen_subcommand_from logout" -l config -d 'OpenClaw config file to update'
complete -c openclaw -n "__fish_seen_subcommand_from logout" -l oauth-path -d 'OAuth file path to remove'
